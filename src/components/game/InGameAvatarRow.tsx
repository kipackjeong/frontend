...
const styles = StyleSheet.create({
  ...
  hostBadge: { position: 'absolute', top: -6, right: -6, backgroundColor: '#fef3c7', borderRadius: 14, width: 28, height: 28, justifyContent: 'center', alignItems: 'center', borderWidth: 1, borderColor: '#fbbf24' },
  badgeText: { fontSize: 14, fontWeight: '800', color: '#92400e', paddingHorizontal: 0, includeFontPadding: false, textAlignVertical: 'center' },
